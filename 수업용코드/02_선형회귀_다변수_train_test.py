...
# np.abs는 화면에 -0. 찍히는 것을 막으려고 씀. 값은 0
...
w5, b5 = 학습(Z_train[:20], y_train[:20], epochs=2000)
print(f"{R2(y_train[:20], 예측(Z_train[:20], w5, b5)):.4f}")
print(f"{R2(y_test, 예측(Z_test, w5, b5)):.4f}")
